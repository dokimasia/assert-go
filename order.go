...
// Pairwise stops the test when any adjacent pair of items fails pred,
...
func Pairwise[T any](tb TB, items []T, pred func(earlier, later T) bool, msg string) {
	tb.Helper()
	matcher.Pairwise(tb, matcher.Fatal, items, pred, msg)
}
